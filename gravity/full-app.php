...
$response_html .= '<h2>Application ID: '. $row['application_id'] .'</h2>';
$response_html .= '<p>First Name: '. $row['first_name'] .'</p>';
$response_html .= '<p>Last Name: '. $row['last_name'] .'</p>';
$response_html .= '<p>Phone: '. $row['phone'] .'</p>';
$response_html .= '<p>Email: '. $row['email'] .'</p>';
$response_html .= '<p>Address: '. $row['address'] .'</p>';
$response_html .= '<p>City: '. $row['city'] .'</p>';
$response_html .= '<p>State: '. $row['state'] .'</p>';
$response_html .= '<p>Zip: '. $row['zip'] .'</p>';
    ...
    <div class="row justify-content-center">
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="block text-center text-lg-start pe-0 pe-xl-5">
          <h1 class="text-capitalize mb-4">Thank You</h1>
          <p class="mb-4">Expect a call and email shortly to discuss details
            <br> And instructions to send in the documents, if any, necessary</p> 
          </div>
      </div>
      <div class="col-lg-6">
